...
#define DEFINE_BITMASK_OPERATORS(ENUM)                                                                                 \
    ...
    [[nodiscard]] inline constexpr auto operator&(ENUM lhs, ENUM rhs) noexcept {                                       \
        ...
        return EnumBitmask::EnumWrapper<ENUM>{ENUM(static_cast<U>(lhs) & static_cast<U>(rhs))};                        \
    }                                                                                                                  \
    [[nodiscard]] inline constexpr auto operator|(ENUM lhs, ENUM rhs) noexcept {                                       \
        using U = std::underlying_type_t<ENUM>;                                                                        \
        return EnumBitmask::EnumWrapper<ENUM>{ENUM(static_cast<U>(lhs) | static_cast<U>(rhs))};                        \
    ...
    inline constexpr ENUM &operator&=(ENUM &lhs, ENUM rhs) noexcept { return lhs = (lhs & rhs); }                      \
    inline constexpr ENUM &operator|=(ENUM &lhs, ENUM rhs) noexcept { return lhs = (lhs | rhs); }                      \
    inline constexpr ENUM &operator^=(ENUM &lhs, ENUM rhs) noexcept { return lhs = (lhs ^ rhs); }
//
////////////////////////////////////////////////////////////////